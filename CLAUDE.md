...
This project is indexed by GitNexus as **syfinance** (8275 symbols, 16723 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
