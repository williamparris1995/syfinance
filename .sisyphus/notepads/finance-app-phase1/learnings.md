...
- Settings flow: Frontend → Tauri command → Scheduler.update_settings() → RwLock update
...
- Database errors: "not found" → "The requested item was not found."
- Validation errors: "invalid" → "Invalid input. Please check your data and try again."
- Network errors: "network error" → "Network error. Please check your connection and try again."
- Balance errors: "insufficient balance" → "Insufficient balance for this transaction."
- Debt errors: "payment already recorded" → "This payment has already been recorded."
- Technical jargon filtered: "sqlx::Error" → "An error occurred. Please try again..."
...
- pnpm vitest run src/__tests__/error-handling.test.tsx: ✓ 17 tests passed
