...
const (
	...
	BackupService_UploadBackup_FullMethodName      = "/yucai.backup.v1.BackupService/UploadBackup"
...
type BackupServiceClient interface {
	...
	UploadBackup(ctx context.Context, in *UploadBackupRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *backupServiceClient) UploadBackup(ctx context.Context, in *UploadBackupRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BackupService_UploadBackup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BackupServiceServer interface {
	...
	// envelope's tenant_id, and the import reuses the hardened purge+import
	// path (R5 D6) with a pre-upload safety backup.
	UploadBackup(context.Context, *UploadBackupRequest) (*emptypb.Empty, error)
...
func (UnimplementedBackupServiceServer) UploadBackup(context.Context, *UploadBackupRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UploadBackup not implemented")
}
...
func _BackupService_UploadBackup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UploadBackupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackupServiceServer).UploadBackup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BackupService_UploadBackup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackupServiceServer).UploadBackup(ctx, req.(*UploadBackupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
