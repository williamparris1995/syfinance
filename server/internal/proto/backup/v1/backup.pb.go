...
func (x *UploadBackupRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
const file_backup_v1_backup_proto_rawDesc = "" +
	...
	"\x15BACKUP_PROVIDER_LOCAL\x10\x012\xd8\x04\n" +
	"\rBackupService\x12U\n" +
	"\fCreateBackup\x12$.yucai.backup.v1.CreateBackupRequest\x1a\x1f.yucai.backup.v1.BackupResponse\x12N\n" +
	"\rRestoreBackup\x12%.yucai.backup.v1.RestoreBackupRequest\x1a\x16.google.protobuf.Empty\x12L\n" +
	"\fUploadBackup\x12$.yucai.backup.v1.UploadBackupRequest\x1a\x16.google.protobuf.Empty\x12X\n" +
...
var file_backup_v1_backup_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_backup_v1_backup_proto_goTypes = []any{
	...
	(*UploadBackupRequest)(nil),      // 4: yucai.backup.v1.UploadBackupRequest
	(*ListBackupsRequest)(nil),       // 5: yucai.backup.v1.ListBackupsRequest
	(*ListBackupsResponse)(nil),      // 6: yucai.backup.v1.ListBackupsResponse
	(*DeleteBackupRequest)(nil),      // 7: yucai.backup.v1.DeleteBackupRequest
	(*CloudSettingsDTO)(nil),         // 8: yucai.backup.v1.CloudSettingsDTO
	(*SaveCloudSettingsRequest)(nil), // 9: yucai.backup.v1.SaveCloudSettingsRequest
	(*CloudSettingsResponse)(nil),    // 10: yucai.backup.v1.CloudSettingsResponse
	(*BackupResponse)(nil),           // 11: yucai.backup.v1.BackupResponse
...
var file_backup_v1_backup_proto_depIdxs = []int32{
	...
	12, // 1: yucai.backup.v1.BackupDTO.created_at:type_name -> google.protobuf.Timestamp
	13, // 2: yucai.backup.v1.ListBackupsRequest.page:type_name -> yucai.common.v1.PageRequest
	...
	14, // 5: yucai.backup.v1.ListBackupsResponse.page:type_name -> yucai.common.v1.PageResponse
	8,  // 6: yucai.backup.v1.SaveCloudSettingsRequest.settings:type_name -> yucai.backup.v1.CloudSettingsDTO
	8,  // 7: yucai.backup.v1.CloudSettingsResponse.settings:type_name -> yucai.backup.v1.CloudSettingsDTO
	...
	4,  // 11: yucai.backup.v1.BackupService.UploadBackup:input_type -> yucai.backup.v1.UploadBackupRequest
	5,  // 12: yucai.backup.v1.BackupService.ListBackups:input_type -> yucai.backup.v1.ListBackupsRequest
	7,  // 13: yucai.backup.v1.BackupService.DeleteBackup:input_type -> yucai.backup.v1.DeleteBackupRequest
	9,  // 14: yucai.backup.v1.BackupService.SaveCloudSettings:input_type -> yucai.backup.v1.SaveCloudSettingsRequest
	15, // 15: yucai.backup.v1.BackupService.GetCloudSettings:input_type -> google.protobuf.Empty
	11, // 16: yucai.backup.v1.BackupService.CreateBackup:output_type -> yucai.backup.v1.BackupResponse
	15, // 17: yucai.backup.v1.BackupService.RestoreBackup:output_type -> google.protobuf.Empty
	15, // 18: yucai.backup.v1.BackupService.UploadBackup:output_type -> google.protobuf.Empty
	6,  // 19: yucai.backup.v1.BackupService.ListBackups:output_type -> yucai.backup.v1.ListBackupsResponse
	15, // 20: yucai.backup.v1.BackupService.DeleteBackup:output_type -> google.protobuf.Empty
	15, // 21: yucai.backup.v1.BackupService.SaveCloudSettings:output_type -> google.protobuf.Empty
	10, // 22: yucai.backup.v1.BackupService.GetCloudSettings:output_type -> yucai.backup.v1.CloudSettingsResponse
