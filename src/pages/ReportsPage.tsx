  ...
  return (
    <PageShell>
        ...
        <div className="flex gap-1.5 mb-3">
          {(['month', 'quarter', 'year'] as DateRangePreset[]).map(preset => (
            <button key={preset}
              ...
              {t(`reports.this${preset.charAt(0).toUpperCase() + preset.slice(1)}`)}
            </button>
          ))}
          <button
      ...
      {isLoading ? (
        ...
        <Tabs defaultValue="balance-sheet" className="w-full">
            ...
            <div className="rounded-[14px] border border-border bg-card p-5">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{t('reports.asOf')} {dateRange.end}</p>
                </div>
          ...
          <TabsContent value="income-statement" className="space-y-4">
            {/* Summary Cards */}
            <div className="grid gap-3.5 md:grid-cols-3 mb-6">
              <div className="rounded-[14px] border border-border bg-card px-5 py-[18px]">
                <div className="text-xs text-muted-foreground mb-1">
                  {t('reports.income')}
                </div>
                <div className="font-display text-[22px] font-semibold tracking-tight text-income">
              ...
              <div className="rounded-[14px] border border-border bg-card px-5 py-[18px]">
                ...
                <div className="font-display text-[22px] font-semibold tracking-tight text-expense">
              ...
              <div className="rounded-[14px] border border-border bg-card px-5 py-[18px]">
                ...
                <div className={cn(
                  ...
                  parseFloat(incomeStatement?.net_income ?? '0') >= 0 ? 'text-income' : 'text-expense'
                )}>
            ...
            <div className="rounded-[14px] border border-border bg-card p-5">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h2 className="text-lg font-semibold">{t('reports.incomeStatement')}</h2>
          ...
          <TabsContent value="year-over-year" className="space-y-4">
            <div className="rounded-[14px] border border-border bg-card p-5">
              <h2 className="text-lg font-semibold mb-4">{t('reports.yoyTitle')}</h2>
              {/* Year selectors */}
      ...
      {(() => {
        ...
        return (
          <div className="rounded-[14px] border border-border bg-card p-5 mt-6">
            <h2 className="text-lg font-semibold mb-1">{t('prepaid.summaryTitle')}</h2>
            <p className="text-xs text-muted-foreground mb-4">{t('prepaid.summaryDesc')}</p>
            <div className="rounded-[14px] border border-border overflow-hidden">
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/50">
