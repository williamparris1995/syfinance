...
class AccountServiceApi {
  ...
  $async.Future<FindByAccountTypeResponse> findByAccountType(
          $pb.ClientContext? ctx, FindByAccountTypeRequest request) =>
      _client.invoke<FindByAccountTypeResponse>(ctx, 'AccountService',
          'FindByAccountType', request, FindByAccountTypeResponse());
  ...
  $async.Future<AccountResponse> createCategory(
          $pb.ClientContext? ctx, CreateCategoryRequest request) =>
      _client.invoke<AccountResponse>(
          ctx, 'AccountService', 'CreateCategory', request, AccountResponse());
  $async.Future<AccountResponse> updateCategory(
          $pb.ClientContext? ctx, UpdateCategoryRequest request) =>
      _client.invoke<AccountResponse>(
          ctx, 'AccountService', 'UpdateCategory', request, AccountResponse());
  $async.Future<$2.Empty> deleteCategory(
          $pb.ClientContext? ctx, DeleteCategoryRequest request) =>
      _client.invoke<$2.Empty>(
          ctx, 'AccountService', 'DeleteCategory', request, $2.Empty());
  $async.Future<$2.Empty> reorderCategories(
          $pb.ClientContext? ctx, ReorderCategoriesRequest request) =>
      _client.invoke<$2.Empty>(
          ctx, 'AccountService', 'ReorderCategories', request, $2.Empty());
}
