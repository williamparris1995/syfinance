...
class TemplateRepositoryImpl implements TemplateRepository {
  ...
  Future<Either<Failure, List<Template>>> list({bool? paused}) =>
      _guard(() => _remote.list(paused: paused));
  ...
  @override
  Future<Either<Failure, Template>> pause(String id) => _guard(() => _remote.pause(id));

  @override
  Future<Either<Failure, Template>> resume(String id) => _guard(() => _remote.resume(id));

  @override
  Future<Either<Failure, Template>> get(String id) => _guard(() => _remote.get(id));

  @override
  Future<Either<Failure, RecordResult>> record(String templateId) =>
      _guard(() => _remote.record(templateId));
