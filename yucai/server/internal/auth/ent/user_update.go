...
func (uu *UserUpdate) SetFamilyRole(ur user.FamilyRole) *UserUpdate {
	uu.mutation.SetFamilyRole(ur)
	return uu
}

// SetNillableFamilyRole sets the "family_role" field if the given value is not nil.
func (uu *UserUpdate) SetNillableFamilyRole(ur *user.FamilyRole) *UserUpdate {
	if ur != nil {
		uu.SetFamilyRole(*ur)
	}
	return uu
...
func (uu *UserUpdate) check() error {
	...
	if v, ok := uu.mutation.FamilyRole(); ok {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.FamilyRole(); ok {
...
// SetFamilyRole sets the "family_role" field.
func (uuo *UserUpdateOne) SetFamilyRole(ur user.FamilyRole) *UserUpdateOne {
	uuo.mutation.SetFamilyRole(ur)
	return uuo
}

// SetNillableFamilyRole sets the "family_role" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableFamilyRole(ur *user.FamilyRole) *UserUpdateOne {
	if ur != nil {
		uuo.SetFamilyRole(*ur)
	}
	return uuo
}
...
func (uuo *UserUpdateOne) check() error {
	...
	if v, ok := uuo.mutation.FamilyRole(); ok {
		if err := user.FamilyRoleValidator(v); err != nil {
			return &ValidationError{Name: "family_role", err: fmt.Errorf(`ent: validator failed for field "User.family_role": %w`, err)}
		}
	}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.FamilyRole(); ok {
		_spec.SetField(user.FieldFamilyRole, field.TypeEnum, value)
	}
