...
func (x *PortfolioPerformanceResponse) GetCagrAnnualizedPct() float64 {
	if x != nil && x.CagrAnnualizedPct != nil {
		return *x.CagrAnnualizedPct
	}
	return 0
}

func (x *PortfolioPerformanceResponse) GetRangeCagrAnnualizedPct() float64 {
	if x != nil && x.RangeCagrAnnualizedPct != nil {
...
type HoldingPerformanceResponse struct {
	...
	CagrAnnualizedPct      *float64               `protobuf:"fixed64,9,opt,name=cagr_annualized_pct,json=cagrAnnualizedPct,proto3,oneof" json:"cagr_annualized_pct,omitempty"`    // 单标的 price-based CAGR (first/range-start price→current)
	RangeCagrAnnualizedPct *float64               `protobuf:"fixed64,10,opt,name=range_cagr_annualized_pct,json=rangeCagrAnnualizedPct,proto3,oneof" json:"range_cagr_annualized_pct,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *HoldingPerformanceResponse) GetCagrAnnualizedPct() float64 {
	if x != nil && x.CagrAnnualizedPct != nil {
		return *x.CagrAnnualizedPct
	}
	return 0
...
func (x *HoldingPerformanceResponse) GetRangeCagrAnnualizedPct() float64 {
	if x != nil && x.RangeCagrAnnualizedPct != nil {
		return *x.RangeCagrAnnualizedPct
	}
	return 0
...
const file_holding_v1_holding_proto_rawDesc = "" +
	...
	"\x05range\x18\x02 \x01(\x0e2\x1c.yucai.holding.v1.CurveRangeR\x05range\x12#\n" +
	"\rbase_currency\x18\x03 \x01(\tR\fbaseCurrency\"\xf0\x04\n" +
	...
	"\x12twr_annualized_pct\x18\b \x01(\x01H\x02R\x10twrAnnualizedPct\x88\x01\x01\x123\n" +
	"\x13cagr_annualized_pct\x18\t \x01(\x01H\x03R\x11cagrAnnualizedPct\x88\x01\x01\x12>\n" +
	"\x19range_cagr_annualized_pct\x18\n" +
	" \x01(\x01H\x04R\x16rangeCagrAnnualizedPct\x88\x01\x01B\x11\n" +
	"\x0f_annualized_pctB\x17\n" +
	"\x15_range_annualized_pctB\x15\n" +
	"\x13_twr_annualized_pctB\x16\n" +
	"\x14_cagr_annualized_pctB\x1c\n" +
	"\x1a_range_cagr_annualized_pct\"Q\n" +
