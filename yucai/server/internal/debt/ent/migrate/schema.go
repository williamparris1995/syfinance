...
var (
	...
	DebtDetailsColumns = []*schema.Column{
		...
		{Name: "cycle", Type: field.TypeString, Comment: "recurrence cycle: weekly, monthly, yearly, custom", Default: "monthly"},
		...
		{Name: "monthly_mode", Type: field.TypeInt32, Nullable: true, Comment: "0 = by date (start-date anchor), 1 = by nth weekday", Default: 0},
		{Name: "nth", Type: field.TypeInt32, Nullable: true, Comment: "1-4 = the Nth, 5 = the last (nth-weekday mode)", Default: 0},
		{Name: "interest_waived_cents", Type: field.TypeInt64, Nullable: true, Comment: "one-off interest waiver, deducted from earliest installments", Default: 0},
		...
		{Name: "guarantor_name", Type: field.TypeString, Comment: "Guarantor name (optional)", Default: ""},
		{Name: "guarantor_contact", Type: field.TypeString, Comment: "Guarantor contact: phone/wechat/... (optional)", Default: ""},
