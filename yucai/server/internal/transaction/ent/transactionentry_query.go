...
func (teq *TransactionEntryQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (teq *TransactionEntryQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (teq *TransactionEntryQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (teq *TransactionEntryQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (teq *TransactionEntryQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (teq *TransactionEntryQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := teq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(transactionentry.FieldTransactionID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.TransactionEntry.Query().
//		Select(transactionentry.FieldTransactionID).
//		Scan(ctx, &v)
...
func (teq *TransactionEntryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(transactionentry.Table, transactionentry.Columns, sqlgraph.NewFieldSpec(transactionentry.FieldID, field.TypeUUID))
	_spec.From = teq.sql
