...
import (
	...
	"github.com/yucai/server/internal/transaction/ent/migrate"
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.TransactionEntry.Intercept(interceptors...)
}
...
// UpdateOneID returns an update builder for the given id.
func (c *TransactionEntryClient) UpdateOneID(id uuid.UUID) *TransactionEntryUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *TransactionEntryClient) DeleteOneID(id uuid.UUID) *TransactionEntryDeleteOne {
...
func (c *TransactionEntryClient) Get(ctx context.Context, id uuid.UUID) (*TransactionEntry, error) {
	return c.Query().Where(transactionentry.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *TransactionEntryClient) GetX(ctx context.Context, id uuid.UUID) *TransactionEntry {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
type (
	hooks struct {
		Transaction, TransactionEntry []ent.Hook
	}
	inters struct {
		Transaction, TransactionEntry []ent.Interceptor
	}
)
