...
const (
	...
	ItemsTable = "budget_items"
	// ItemsInverseTable is the table name for the BudgetItem entity.
	// It exists in this package in order to avoid circular dependency with the "budgetitem" package.
	ItemsInverseTable = "budget_items"
	// ItemsColumn is the table column denoting the items relation/edge.
	ItemsColumn = "budget_id"
)
