...
func (cq *CurrencyQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (cq *CurrencyQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(currency.Table, currency.Columns, sqlgraph.NewFieldSpec(currency.FieldID, field.TypeUUID))
	_spec.From = cq.sql
