...
func (tu *TagUpdate) SetVersion(i int64) *TagUpdate {
...
func (tu *TagUpdate) SetNillableVersion(i *int64) *TagUpdate {
	if i != nil {
		tu.SetVersion(*i)
	}
	return tu
...
func (tu *TagUpdate) AddVersion(i int64) *TagUpdate {
...
func (tu *TagUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.Version(); ok {
		_spec.SetField(tag.FieldVersion, field.TypeInt64, value)
	}
	if value, ok := tu.mutation.AddedVersion(); ok {
		_spec.AddField(tag.FieldVersion, field.TypeInt64, value)
	}
...
// SetVersion sets the "version" field.
func (tuo *TagUpdateOne) SetVersion(i int64) *TagUpdateOne {
...
// SetNillableVersion sets the "version" field if the given value is not nil.
func (tuo *TagUpdateOne) SetNillableVersion(i *int64) *TagUpdateOne {
	if i != nil {
		tuo.SetVersion(*i)
	}
	return tuo
...
// AddVersion adds i to the "version" field.
func (tuo *TagUpdateOne) AddVersion(i int64) *TagUpdateOne {
