...
func (tc *TagCreate) SetTenantID(u uuid.UUID) *TagCreate {
...
func (tc *TagCreate) SetVersion(i int64) *TagCreate {
	tc.mutation.SetVersion(i)
	return tc
}

// SetNillableVersion sets the "version" field if the given value is not nil.
func (tc *TagCreate) SetNillableVersion(i *int64) *TagCreate {
	if i != nil {
		tc.SetVersion(*i)
	}
	return tc
...
func (tc *TagCreate) createSpec() (*Tag, *sqlgraph.CreateSpec) {
	...
	if value, ok := tc.mutation.TenantID(); ok {
		_spec.SetField(tag.FieldTenantID, field.TypeUUID, value)
