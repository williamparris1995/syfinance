...
## 追加发版:v1.0.8+9(2026-09-19)

- sprint-2 F37 到期紧迫度标识+F38 模板锚定漂移修复+日期字段时区归一化(合并 `86e55c85`/`a9f95169`);tag `v1.0.8`→Actions 绿[run 35446387763]→Release 双资产,稳定订阅地址已供 1.0.8。
