...
- [ ] **feature F35** repayment-plan-panel — 贷款账户详情页接入还款计划面板(现「待 payment_schedule 模块接入」占位;按 accountId 关联债务复用 schedule 数据源) — claimed: zcode-r14 2026-09-18(worktree .claude/worktrees/r14-f35)
