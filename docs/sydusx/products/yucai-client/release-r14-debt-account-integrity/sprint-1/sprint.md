...
- [ ] **feature F33** debt-subtype — subtype 全链路可编辑 + 9 类扩展(proto `UpdateDebtRequest` 加 `subtype`;server handler/params 接线;client UpdateDebtParams/repo/DS/表单 chips 解禁;sync envelope 补字段)
