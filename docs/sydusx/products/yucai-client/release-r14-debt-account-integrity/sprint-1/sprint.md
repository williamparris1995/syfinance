...
- [ ] **feature F36** liability-posting — 负债记账治本方案 A(借入创建即入账/还款全额过账/余额=−未还本金不变式 + 存量 debt 关联账户余额修复) — claimed: zcode-r14 2026-09-19(worktree .claude/worktrees/r14-f36;spec 草案待用户拍板 3 决策点)
