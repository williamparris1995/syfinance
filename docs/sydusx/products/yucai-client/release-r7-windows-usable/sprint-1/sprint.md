...
- [ ] **feature A** 2026-08-29-a1-windows-packaging — Windows 打包/安装通路:flutter build windows 产物 + 安装器(exe installer/msix,analysis 定) + 版本戳 + 全新安装三判据复验脚本/清单;ticket 11 的 client 面 `claimed: zcode-main 2026-08-29`
...
## status: in-progress(feature A 待 claim)
