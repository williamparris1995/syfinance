...
- [x] **feature I** 2026-08-20-offline-e2e-acceptance — 三条成功判据 e2e 验收(断网安装记账 / 登录上云 / 不绑定永远本地)(依赖 G,H)✅ done(merged `bc0dbbd3`,2026-08-23;4 组判据集成测试+人工清单,三轮 review[核心教训:mock 形状=被测世界形状])
- [x] **feature J** 2026-08-22-archive-export-import — 存档导出/导入:加密 backup 文件 file picker 手动流转,多设备迁移/云盘备份(依赖 G)✅ done(merged `929cb4e3`,2026-08-23;YC1E codec[server 格式逐字节复刻]+全量替换 importer+设置页完整交互链,三轮 review)

**defer**:绑定后离线续写(ticket 16);非空账号合并。

## status: done(2026-08-23,G/H/I/J 四 feature 全 merged——R6 sprint-3「绑定链路+镜像+e2e+存档」收官)
