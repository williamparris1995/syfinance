...
- [ ] **feature G** 2026-08-20-bind-upload — 绑定上传:OIDC 登录 → 空账号预检 guard(M3)→ 本地快照转 backup 格式经 RestoreBackup 单向上传 → 回切 server 权威在线(零 server 改动)(依赖 sprint-2) `claimed: zcode-main 2026-08-23`
