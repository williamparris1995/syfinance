...
- [ ] **feature A** 2026-08-20-drift-local-db — drift 本地库落地(全业务实体 schema + DI 注册 + proto DTO 契约对齐,零 server 改动) `claimed: zcode-main 2026-08-20`
- [ ] **feature B** 2026-08-20-auth-offline-fork — AppStarted 失败分流 + 游客模式(路由守卫放开,离线不踢登录页,对所有用户生效)
