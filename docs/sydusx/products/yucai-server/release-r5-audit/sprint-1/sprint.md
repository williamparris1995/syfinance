...
- [ ] **feature D** 2026-08-01-d13-encryption-layering — D13 加密分层(safety 用户密码 / auto 明文+0600+UI 标注)+ D19a scrypt N 2^17 版本化 KDF header(依赖 B) `claimed: zcode-main 2026-08-23`
