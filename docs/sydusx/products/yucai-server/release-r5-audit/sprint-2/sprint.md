...
- [ ] **feature H** 2026-08-23-f4-cagr-primary-switch — 06 决策 1:portfolioXIRR 切主指标;portfolioCAGR 降级辅助+口径标注(「仅当前持仓成本→市值」;client UI 重命名/tooltip 属 R5 scope 外——server DTO 层就位+client defer 记档);依赖 G(XIRR 修后数值稳定)——pivot A 裁决:G 后评估顺手/延后
